package com.bog.ecommerce.exception;
...
public class GeneralExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMissingServletRequestParameter(
        ...
        apiError.put("status",HttpStatus.BAD_REQUEST);
        apiError.put("message", ex.getLocalizedMessage());
        apiError.put("error",error);
        return new ResponseEntity<>(apiError, new HttpHeaders(), (HttpStatus) apiError.get("status"));
    }
